...
<td class="cellrowborder" valign="top" width="61.39%" headers="mcps1.2.3.1.2 "><p>tensor通过<code>record_stream</code>在内存池上添加标记后，该标记已被stream使用，可以通过该接口移除该标记</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61.39%" headers="mcps1.2.3.1.2 "><p><a name="p1281815913362"></a><a name="p1281815913362"></a>当前接口提供了类似原生print特性且不影响aclgraph replay的tensor dump能力，允许将aclgraph中间节点的tensor数据、数据类型、shape信息保存到指定的".pt"或".bin"文件中以便用户观察aclgraph的执行过程，以快速定位问题。</p>
</td>
</tr>
