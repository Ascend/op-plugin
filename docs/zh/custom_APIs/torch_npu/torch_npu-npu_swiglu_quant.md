...
- 计算公式：
    ...
    - quant量化：
        ...
        2. 动态/静态量化操作：对激活后的结果进行量化，以动态量化（dynamic_quant）为例，详细数学公式请参考aclnnSwiGluQuantV2。
        <!-- (https://www.hiascend.com/document/detail/zh/canncommercial/900/API/aolapi/context/ops-nn/aclnnSwiGluQuantV2.md) -->
