...
> [!NOTE]  
> Ascend Extension for PyTorch部分功能可以通过环境变量实现，具体可参考《[环境变量参考](https://gitcode.com/Ascend/pytorch/blob/v2.7.1-7.3.0/docs/zh/environment_variable_reference/env_variable_list.md)》。
