...
以下采集项的结果数据含义可参见《CANN 性能调优工具》中的“<a href="https://www.hiascend.com/document/detail/zh/canncommercial/900/devaids/Profiling/atlasprofiling_16_0067.html">op_summary（算子详细信息）</a>”章节，但具体采集结果请以实际情况为准。
