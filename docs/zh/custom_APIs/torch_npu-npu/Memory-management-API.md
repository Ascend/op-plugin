...
<td class="cellrowborder" rowspan="18" valign="top" width="36.39%" headers="mcps1.2.3.1.2 "><p id="p6146131084320"><a name="p6146131084320"></a><a name="p6146131084320"></a>TorchNPU提供内存管理相关的部分接口，具体可参考<a href="https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.1.0/docs/zh/native_apis/pytorch_2-7-1/torch-cuda.md">torch.cuda</a>。</p>
</td>
</tr>
