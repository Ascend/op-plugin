...
- Enables deterministic computation. A deterministic algorithm ensures that the model produces identical outputs for identical inputs during each forward propagation.
- Deterministic algorithms can avoid the accumulation of small random errors during each forward propagation. They are very useful in scenarios where repeated testing or model performance comparison is required.
...
Computation result of `enable_deterministic_with_backward`.
