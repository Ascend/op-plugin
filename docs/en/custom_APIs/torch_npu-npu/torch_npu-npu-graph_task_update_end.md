...
Marks the end of the task to be updated in `NPUGraph` scenarios.
 ...
 **`stream`** (`torch_npu.npu.Stream`): Required. Stream in graph update mode.
...
- In the graph capture phase, call [torch_npu.npu.graph_task_group_begin](torch_npu-npu-graph_task_group_begin.md) and [torch_npu.npu.graph_task_group_end](torch_npu-npu-graph_task_group_end.md) together to generate a task group handle.
- In the graph update phase, use this API together with [torch_npu.npu.graph_task_update_begin](torch_npu-npu-graph_task_update_begin.md) to mark the beginning and end of the task to be updated.
- The input `stream` must be the same as that of [torch_npu.npu.graph_task_update_begin](torch_npu-npu-graph_task_update_begin.md).
