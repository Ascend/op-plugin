...
**Table 1** Memory management APIs

<a name="table683971665519"></a>
<table><thead align="left"><tr id="row1357083844218"><th class="cellrowborder" valign="top" width="63.61%" id="mcps1.2.3.1.1"><p id="p1757053818424"><a name="p1757053818424"></a><a name="p1757053818424"></a>API</p>
</th>
<th class="cellrowborder" valign="top" width="36.39%" id="mcps1.2.3.1.2"><p id="p2057018381424"><a name="p2057018381424"></a><a name="p2057018381424"></a>Description</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" rowspan="18" valign="top" width="36.39%" headers="mcps1.2.3.1.2 "><p id="p6146131084320"><a name="p6146131084320"></a><a name="p6146131084320"></a>Memory management-related APIs provided by <code>torch_npu</code>. For details, see <a href="https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.0.0/docs/en/native_apis/pytorch_2-7-1/torch-cuda.md">torch.cuda</a>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="36.39%" headers="mcps1.2.3.1.2 "><p id="p172891387258"><a name="p172891387258"></a><a name="p172891387258"></a>Provides a lightweight version of <code>empty_cache</code> that releases only virtual memory. This API is called the same way as <code>torch_npu.npu.empty_cache</code>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="36.39%" headers="mcps1.2.3.1.2 "><p id="p172891387259"><a name="p172891387259"></a><a name="p172891387259"></a>This API involves high-risk operations. For details, see <a href="torch-npu-npu-NPUPluggableAllocator.md">torch_npu.npu.NPUPluggableAllocator</a>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="36.39%" headers="mcps1.2.3.1.2 "><p id="p75031810165517"><a name="p75031810165517"></a><a name="p75031810165517"></a>This API involves high-risk operations. For details, see <a href="torch-npu-npu-change_current_allocator.md">torch_npu.npu.change_current_allocator</a>.</p>
</td>
</tr>
<tr id="row10860101635514"><td class="cellrowborder" width="63.61%" valign="top" headers="mcps1.2.3.1.1 "><p id="p681913541225"><a name="p681913541225"></a><a name="p681913541225"></a><a href="torch_npu-npu-host_empty_cache.md">torch_npu.npu.host_empty_cache</a></p>
</td>
