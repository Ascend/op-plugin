...
<td class="cellrowborder" valign="top" width="62.6%" headers="mcps1.2.3.1.2 "><p id="p136645713159"><a name="p136645713159"></a><a name="p136645713159"></a>Controls whether to use proprietary formats. When set to <code>True</code>, proprietary formats are allowed. When set to <code>False</code>, allocation of tensors in any proprietary format is not allowed, preventing proprietary formats from being propagated in the adaptation layer.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62.6%" headers="mcps1.2.3.1.2 "><p id="p428393116322"><a name="p428393116322"></a><a name="p428393116322"></a>Initializes the dump process as the entry point of the dump workflow.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62.6%" headers="mcps1.2.3.1.2 "><p id="p8367104315247"><a name="p8367104315247"></a><a name="p8367104315247"></a>Ends the dump process and triggers a write of the dump data to the drive.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62.6%" headers="mcps1.2.3.1.2 "><p id="p1236764317242"><a name="p1236764317242"></a><a name="p1236764317242"></a>Sets whether to enable JIT compilation.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="61.39%" headers="mcps1.2.3.1.2 "><p>Wraps the AscendCL Event. During graph capture in <code>NPUGraph</code> scenarios, <code>ExternalEvent</code> is captured as an external graph node for timing control outside the graph.</p>
</td>
</tr>
...
<td class="cellrowborder" rowspan="9" valign="top" width="61.24000000000001%" headers="mcps1.2.3.1.2 "><p id="en-us_topic_0000001788617484_p45278137545"><a name="en-us_topic_0000001788617484_p45278137545"></a><a name="en-us_topic_0000001788617484_p45278137545"></a>Random number generator-related APIs provided by TorchNPU. For details, see <a href="https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.1.0/docs/en/native_apis/pytorch_2-7-1/torch-cuda.md">torch.cuda</a>.</p>
</td>
</tr>
...
<td class="cellrowborder" rowspan="18" valign="top" width="36.39%" headers="mcps1.2.3.1.2 "><p id="en-us_topic_0000001863035964_p6146131084320"><a name="en-us_topic_0000001863035964_p6146131084320"></a><a name="en-us_topic_0000001863035964_p6146131084320"></a>Memory management-related APIs provided by TorchNPU. For details, see <a href="https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.1.0/docs/en/native_apis/pytorch_2-7-1/torch-cuda.md">torch.cuda</a>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62.029999999999994%" headers="mcps1.2.3.1.2 "><p id="p2038911486504"><a name="p2038911486504"></a><a name="p2038911486504"></a>Marks the start of an instrumentation range at the thread level.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62.029999999999994%" headers="mcps1.2.3.1.2 "><p id="p2038911486504"><a name="p2038911486504"></a><a name="p2038911486504"></a>Marks the end of an instrumentation range at the thread level.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62.029999999999994%" headers="mcps1.2.3.1.2 "><p id="p1995741111568"><a name="p1995741111568"></a><a name="p1995741111568"></a>Marks the end of an instrumentation range at the thread level.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62.029999999999994%" headers="mcps1.2.3.1.2 "><p id="p2038911486504"><a name="p2038911486504"></a><a name="p2038911486504"></a>Performs API-level instrumentation that allows users to select APIs or functions for collecting execution duration.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62.029999999999994%" headers="mcps1.2.3.1.2 "><p id="p1059918319532"><a name="p1059918319532"></a><a name="p1059918319532"></a>Provides the <code>mstx_range</code> decorator to collect the execution duration of the range of the decorated function.</p>
</td>
</tr>
</tbody>
</table>
