...
Controls whether to use proprietary formats. When set to `True`, proprietary formats are allowed. When set to `False`, allocation of tensors in any proprietary format is not allowed, preventing proprietary formats from being propagated in the adaptation layer.
