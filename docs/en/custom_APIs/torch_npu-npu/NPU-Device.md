...
**Table 1** NPU device APIs

<a name="table13377193418547"></a>
<table><thead align="left"><tr id="row1888615477417"><th class="cellrowborder" valign="top" width="54.559999999999995%" id="mcps1.2.3.1.1"><p id="p188634764114"><a name="p188634764114"></a><a name="p188634764114"></a>API</p>
</th>
<th class="cellrowborder" valign="top" width="45.440000000000005%" id="mcps1.2.3.1.2"><p id="p188862474415"><a name="p188862474415"></a><a name="p188862474415"></a>Description</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" rowspan="11" valign="top" width="45.440000000000005%" headers="mcps1.2.3.1.2 "><p id="p20972816174218"><a name="p20972816174218"></a><a name="p20972816174218"></a>Device-related APIs provided by <code>torch_npu</code>. For details, see <a href="https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.0.0/docs/en/native_apis/pytorch_2-7-1/torch-cuda.md">torch.cuda</a>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="45.440000000000005%" headers="mcps1.2.3.1.2 "><p id="p1036412951413"><a name="p1036412951413"></a><a name="p1036412951413"></a>Reserved API, not supported currently. The API returns <code>None</code> by default.</p>
</td>
</tr>
</tbody>
</table>
