...
> [!NOTICE]  
> This API is planned for deprecation. For details about the replacement, see [Small Operator Concatenation Solution](https://gitcode.com/Ascend/op-plugin/blob/26.1.0/test/test_base_ops/test_nms_rotated.py).
