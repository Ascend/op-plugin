...
- **`valid_outputs`** (`Tensor`): 0D integer tensor indicating the number of valid elements in `selected_indices`. The valid elements are placed at the beginning in order.
