...
- Fuses `AlltoAll` communication, `Permute` (to ensure contiguous memory addresses after communication), and `Matmul` computation using a **communication-before-computation** sequence.
