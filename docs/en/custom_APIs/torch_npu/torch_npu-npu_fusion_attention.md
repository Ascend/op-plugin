...
- **`query`** (`Tensor`): Required. The data type can be `float16`, `bfloat16`, or `float32`. The data layout can be ND. For details about the overall constraints, see [Constraints](#en-us_topic_0000001742717129_section12345537164214).
- **`key`** (`Tensor`): Required. The data type can be `float16`, `bfloat16`, or `float32`. The data layout can be ND. For details about the overall constraints, see [Constraints](#en-us_topic_0000001742717129_section12345537164214).
- **`value`** (`Tensor`): Required. The data type can be `float16`, `bfloat16`, or `float32`. The data layout can be ND. For details about the overall constraints, see [Constraints](#en-us_topic_0000001742717129_section12345537164214).
- **`head_num`** (`int`): Required. Number of heads. The data type can be `int64`. For details about the overall constraints, see [Constraints](#en-us_topic_0000001742717129_section12345537164214).
...
- **`pse`** (`Tensor`): Optional. Position embedding configuration. The data type can be `float16`, `bfloat16`, or `float32`. The data layout can be ND.
...
- **`pre_tockens`** (`int`): Optional. Parameter used for sparse computation. The data type can be `int64`. The default value is `2147483647`. For details about the overall constraints, see [Constraints](#en-us_topic_0000001742717129_section12345537164214).
- **`next_tockens`** (`int`): Optional. Parameter used for sparse computation. The data type can be `int64`. The default value is `2147483647`. For the relationship between `next_tockens`, `pre_tockens`, and `atten_mask`, refer to the configuration of the `sparse_mode` parameter. Any inconsistency between the parameter value and the actual `atten_mask` distribution will cause precision degradation. For details about the overall constraints, see [Constraints](#en-us_topic_0000001742717129_section12345537164214).
