...
- **`loss`** (`Tensor`): Loss tensor representing the difference between the forward network output and the target distribution, $Loss$ in the formula. The data type can be `float32`.
