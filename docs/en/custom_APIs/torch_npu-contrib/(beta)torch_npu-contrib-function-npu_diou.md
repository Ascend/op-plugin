...
Applies an NPU-based DIoU operation. DIoU considers both the overlap ratio and the distance between target bounding boxes to improve localization stability.
