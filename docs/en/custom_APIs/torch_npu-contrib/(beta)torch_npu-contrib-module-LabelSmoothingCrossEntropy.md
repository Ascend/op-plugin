...
- **`smooth_factor`** (`float`): Label smoothing factor. You are advised to set this parameter to `0.1` when label smoothing is enabled. The value range of this parameter is [0, 1]. The default value is `0`.
