...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p15123104845216"><a name="p15123104845216"></a><a name="p15123104845216"></a>This API is planned for deprecation. Use <code>tensor.to()</code> instead.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p208131543205314"><a name="p208131543205314"></a><a name="p208131543205314"></a>This API is planned for deprecation. For details about the replacement, see <a href="https://gitcode.com/Ascend/op-plugin/blob/26.1.0/test/test_base_ops/test_nms_rotated.py" target="_blank" rel="noopener noreferrer">Small Operator Concatenation Solution</a>.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><p id="p74504207559"><a name="p74504207559"></a><a name="p74504207559"></a>This API is planned for deprecation. Use <code>torch.nn.SiLU</code> instead.</p>
</td>
</tr>
