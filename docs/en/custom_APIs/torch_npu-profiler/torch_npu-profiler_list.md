...
| [torch_npu.profiler.dynamic_profile.set_state](./torch_npu-profiler-dynamic_profile-set_state.md) | Sets the number of training steps executed during dynamic profiling.                     |
...
| [set_custom_trace_id_callback](set_custom_trace_id_callback.md) | Sets the callback for generating a `trace_id`.                                     |
| [get_trace_id](get_trace_id.md)                              | Gets the current `trace_id`.                                         |
