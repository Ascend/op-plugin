...
- **`torch_npu.profiler.ProfilerLevel.Level0`**: Optional. Collects upper-layer application data, lower-layer NPU data, or information about operators executed on the NPU. If this parameter is provided, the tool collects only partial data and omits some operator information. For details, see <a href="https://gitcode.com/Ascend/msprof/blob/26.1.0/docs/en/user_guide/profile_data_file_references.md#op_summary-operator-details">op_summary (Operator Details)</a> in the *msProf* documentation.
