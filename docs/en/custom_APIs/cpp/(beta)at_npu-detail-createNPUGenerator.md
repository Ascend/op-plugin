...
Creates the default generator for an NPU device. The return value type is `Generator`, which is identical to `at::Generator at::cuda::detail::createCUDAGenerator(c10::DeviceIndex _device_index_ = -1)`.
