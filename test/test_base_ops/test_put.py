...
class TestPut(TestCase):
    ...
    def test_put_aicpu_common_shape_format_fp32(self):
        shape_format = [
    ...
    def test_put_aicore_common_shape_format_fp32(self):
        shape_format = [
    ...
    def test_put_aicpu_common_shape_format_fp16(self):
        shape_format = [
    ...
    def test_put_aicore_common_shape_format_fp16(self):
        shape_format = [
