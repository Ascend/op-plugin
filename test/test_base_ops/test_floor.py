...
class TestFloor(TestCase):
    ...
    def test_floor_float32_shape_format(self):
        format_list = [0, 3]
    ...
    def test_floor_inter_float32_shape_format(self):
        format_list = [0, 3]
        shape_list = [[256, 1, 1, 1], [1024, 32, 7, 7], [1024, 32, 7], [1024, 32], [1024]]
        shape_format = [
            [np.float32, i, j] for i in format_list for j in shape_list
    ...
    def test_floor_out_float32_shape_format(self):
        shape_format = [
    ...
    def test_floor_float16_shape_format(self):
        format_list = [0, 3]
        shape_list = [[256, 1, 1, 1], [1024, 32, 7, 7], [1024, 32, 7], [1024, 32], [1024]]
        shape_format = [
    ...
    def test_floor_inter_float16_shape_format(self):
        format_list = [0, 3]
        shape_list = [[256, 1, 1, 1], [1024, 32, 7, 7], [1024, 32, 7], [1024, 32], [1024]]
        shape_format = [
            [np.float16, i, j] for i in format_list for j in shape_list
    ...
    def test_floor_out_float16_shape_format(self):
        shape_format = [
