...
class TestMaskedFill(TestCase):
    ...
    def test_masked_fill_shape_format_fp16(self):
        format_list = [0]
    ...
    def test_masked_fill_shape_format_fp32(self):
        format_list = [0]
        shape_list = [[1024], [32, 1024], [32, 8, 1024], [128, 32, 8, 1024]]
        value_list = [1.25,
                      torch.tensor(1.25, dtype=torch.float32),
    ...
    def test_masked_fill_shape_format_int32(self):
        format_list = [0]
        shape_list = [[1024], [32, 1024], [32, 8, 1024], [128, 32, 8, 1024]]
        value_list = [1.25,
                      torch.tensor(1.25, dtype=torch.float32),
    ...
    def test_masked_fill_shape_format_int64(self):
        format_list = [0]
        shape_list = [[1024], [32, 1024], [32, 8, 1024], [128, 32, 8, 1024]]
        value_list = [1.25,
                      torch.tensor(1.25, dtype=torch.float32),
