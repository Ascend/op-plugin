...
class TestLog(TestCase):
    ...
    def test_log_shape_format_fp32(self):
        format_list = [3]
        shape_list = [(4, 4)]
        shape_format = [
    ...
    def test_log_shape_format_fp16(self):
        format_list = [3]
        shape_list = [(4, 4)]
        shape_format = [
    ...
    def test_log_inp_shape_format_fp32(self):
        format_list = [3]
        shape_list = [(4, 4)]
        shape_format = [
            [np.float32, i, j] for i in format_list for j in shape_list
    ...
    def test_log_inp_shape_format_fp16(self):
        format_list = [3]
        shape_list = [(4, 4)]
        shape_format = [
            [np.float16, i, j] for i in format_list for j in shape_list
    ...
    def test_log_inp_uncon_shape_format_fp32(self):
        format_list = [3]
        shape_list = [(8, 6)]
        shape_format = [
            [np.float32, i, j] for i in format_list for j in shape_list
