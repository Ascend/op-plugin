...
class TestQuantizePerChannel(TestCase):
    ...
    def test_per_channel_3_3_0_qint32(self):
    ...
    def test_per_channel_3_3_3_3_1_qint8(self):
        input_x1, scales, zero_points = self.generate_data_per_channel(-1, 1, (3, 3), (3,), (3,), np.float32,
                                                                       np.float32, np.int8)
    ...
    def test_per_channel_3_3_3_3_3_3_3_3_4_quint8(self):
    ...
    def test_per_channel_30_30_30_30_30_2_quint8(self):
    ...
    def test_per_channel_dequantize_30_30_30_30_30_2_quint8(self):
        input_x1, scales, zero_points = self.generate_data_per_channel(-1, 1, (30, 30, 30, 30), (30,), (30,),
                                                                       np.float32, np.float32, np.uint8)
