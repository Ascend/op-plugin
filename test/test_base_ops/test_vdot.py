...
class TestVdot(TestCase):
    ...
    def cpu_op_exec(self, input1, input2):
        output = torch.vdot(input1, input2)
        output = output.numpy()
        return output
    ...
    def npu_op_exec_out(self, input1, input2, input3):
        ...
        torch.vdot(input1, input2, out=output)
        output = output.to("cpu")
        output = output.numpy()
        return output

    def test_vdot_float32(self, device="npu"):
    ...
    def test_vdot_float32_out(self, device="npu"):
    ...
    def test_vdot_float16(self, device="npu"):
    ...
    def test_vdot_float16_out(self, device="npu"):
