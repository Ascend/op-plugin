...
class TestQuantizePerTensor(TestCase):
    ...
    def test_per_tensor_3_3_0p1_10_qint32(self):
    ...
    def test_per_tensor_3_3_0p1_10_qint8(self):
        input_x1 = self.generate_data_per_tensor(-1, 1, (3, 3), np.float32)
    ...
    def test_per_tensor_3_3_3_3_3_3_0p1_10_quint8(self):
    ...
    def test_per_tensor_30_30_30_30_30_30_0p01_5_quint8(self):
    ...
    def test_per_tensor_dequantize_30_30_30_30_30_30_0p01_5_quint8(self):
        input_x1 = self.generate_data_per_tensor(-1, 1, (30, 30, 30, 30, 30, 30), np.float32)
