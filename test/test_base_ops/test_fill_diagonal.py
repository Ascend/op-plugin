...
class TestFillDiagonal(TestCase):
    ...
    def test_fill_diagonal_shape_format_fp32(self):
        format_list = [0, 3]
    ...
    def test_fill_diagonal_shape_format_fp16(self):
        format_list = [0, 3]
        shape_list = ([7, 3], [3, 3, 3])
        shape_format = [
    ...
    def test_fill_diagonal_false_shape_format_fp32(self):
        format_list1 = [0, 3]
    ...
    def test_fill_diagonal_false_shape_format_fp16(self):
        format_list1 = [0, 3]
        shape_list1 = ([7, 3], [3, 3, 3])
        shape_format = [
