...
class TestLogicalAnd(TestCase):
    ...
    def cpu_op_exec(self, input1, input2):
        output = torch.logical_xor(input1, input2)
        output = output.numpy()
        return output
    ...
    def cpu_op_exec_out(self, input1, input2, input3):
        torch.logical_xor(input1, input2, out=input3)
        output = input3.numpy()
        return output
    ...
    def npu_op_exec_out(self, input1, input2, input3):
        ...
        torch.logical_xor(input1, input2, out=output)
        output = output.to("cpu")
        output = output.numpy()
        return output

    def cpu_op_exec_(self, input1, input2):
        output = torch.Tensor.logical_xor_(input1, input2)
        output = output.numpy()
        return output
    ...
    def logical_xor_out_result(self, shape_format):
    ...
    def test_logical_xor_out(self):
        ...
        self.logical_xor_out_result(shape_format)

    def test_logical_xor_bool(self):
