...
class TestBitwiseLeftShift(TestCase):
    def cpu_op_exec(self, input1, input2):
        output = torch.bitwise_left_shift(input1, input2)
        output = output.numpy()
        return output
    ...
    def test_bitwise_left_shift_tensor(self, device="npu"):
        format_list = [0]
    ...
    def test_bitwise_left_shift_tensor_out(self, device="npu"):
        shape_format = [
