...
class TestRotatedBox(TestCase):
    ...
    def test_rotated_boxes_encode_fp32(self):
    ...
    def test_rotated_boxes_decode_fp32(self):
    ...
    def test_rotated_boxes_encode_fp16(self):
    ...
    def test_rotated_boxes_decode_fp16(self):
