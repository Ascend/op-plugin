...
class TestForeachNorm(TestCase):
    ...
    def test_foreach_norm_out_float32_shpae_tensor_num(self):
        ...
        for tensor_num in tensor_num_list :
            ...
            cpu_output = torch._foreach_norm(cpu_tensors[0])
            npu_output = torch._foreach_norm(npu_tensors[0])
    ...
    def test_foreach_norm_out_float16_shpae_tensor_num(self):
        ...
        for tensor_num in tensor_num_list :
            ...
            cpu_output = tuple([out.half() for out in torch._foreach_norm(cpu_tensors[0])])
            npu_output = torch._foreach_norm(npu_tensors[0])
    ...
    def test_foreach_norm_out_bfloat16_shpae_tensor_num(self):
        ...
        for tensor_num in tensor_num_list :
            ...
            cpu_output = tuple([out.to(torch.bfloat16) for out in torch._foreach_norm(cpu_tensors[0])])
            npu_output = torch._foreach_norm(npu_tensors[0])
