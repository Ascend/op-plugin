...
class TestGreaterEqual(TestCase):
    ...
    def cpu_op_exec_scalar(self, input1, scalar):
        output = torch.greater_equal(input1, scalar)
        output = output.numpy()
        return output

    def cpu_op_exec_scalar_out(self, input1, scalar, input2):
        torch.greater_equal(input1, scalar, out=input2)
        output = input2.numpy()
        return output
    ...
    def greater_equal_tensor_out_result(self, shape_format):
    ...
    def test_greater_equal_tensor_out(self):
        shape_format = [
        ...
        self.greater_equal_tensor_out_result(shape_format)

    def greater_equal_scalar_out_result(self, shape_format):
        for item in shape_format:
            cpu_input1, npu_input1 = create_common_tensor(item[0], -100, 100)
    ...
    def test_greater_equal_scalar_out(self):
        ...
        self.greater_equal_scalar_out_result(shape_format)
    ...
    def test_greater_equal_scalar_float32(self):
        format_list = [0]
        shape_list = [(5, 3), (2, 3, 4)]
        shape_format = [
    ...
    def test_greater_equal_scalar_float16(self):
        format_list = [0]
        shape_list = [(5, 3), (2, 3, 4)]
        shape_format = [
    ...
    def test_greater_equal_tensor_float32(self):
        format_list = [0]
        shape_list = [(5, 3), (2, 3, 4)]
    ...
    def test_greater_equal_tensor_float16(self):
        format_list = [0]
        shape_list = [(5, 3), (2, 3, 4)]
    ...
    def test_greater_equal_inplace_float32(self):
        format_list = [0]
        shape_list = [(5, 3), (2, 3, 4)]
        shape_format = [[[np.float32, i, j], [np.float32, i, j]]
                        for i in format_list for j in shape_list]
    ...
    def test_greater_equal_inplace_float16(self):
        format_list = [0, 3]
        shape_list = [(5, 3), (2, 3, 4)]
        shape_format = [[[np.float16, i, j], [np.float16, i, j]]
                        for i in format_list for j in shape_list]
    ...
    def test_greater_equal_inplace_scalar_float32(self):
        format_list = [0]
        shape_list = [(5, 3), (2, 3, 4)]
        shape_format = [
            [np.float32, i, j] for i in format_list for j in shape_list
    ...
    def test_greater_equal_inplace_scalar_float16(self):
        format_list = [0]
        shape_list = [(5, 3), (2, 3, 4)]
        shape_format = [
            [np.float16, i, j] for i in format_list for j in shape_list
    ...
    def test_greater_equal_mix_dtype(self):
