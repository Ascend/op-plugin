...
class TestFloorDivide(TestCase):
    ...
    def test_floor_divide_float32(self):
    ...
    def test_floor_divide_float32_out(self):
    ...
    def test_floor_divide_scalar_float32(self):
    ...
    def test_floor_divide_scalar_bool(self):
    ...
    def test_floor_divide_uncontiguous_float32_scalar(self):
