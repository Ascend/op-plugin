...
class TestSigmoid(TestCase):
    ...
    def test_sigmoid_shape_format_fp16(self):
        format_list = [0]
    ...
    def test_sigmoid_shape_format_fp32(self):
    ...
    def test_sigmoid_out_float32_shape_format(self):
        shape_format = [
    ...
    def test_sigmoid_out_float16_shape_format(self):
        shape_format = [
