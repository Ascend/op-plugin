...
class TestNPUKvRmsNormRopeCache(TestCase):
    ...
    @unittest.skip("skip test_npu_kv_rmsnorm_rope_cache_PA_BNSD case")
    ...
    @unittest.skip("skip test_npu_kv_rmsnorm_rope_cache_PA_BLK_NZ case")
    @SupportedDevices(['Ascend910B'])
    ...
    @unittest.skip("skip test_npu_kv_rmsnorm_rope_cache_PA_BLK_BNSD case")
    @SupportedDevices(['Ascend910B'])
    ...
    @unittest.skip("skip test_npu_kv_rmsnorm_rope_cache_PA_NZ case")
    @SupportedDevices(['Ascend910B'])
