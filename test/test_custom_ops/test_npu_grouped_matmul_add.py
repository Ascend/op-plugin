...
class TestGroupedMatmulAdd(TestCase):
    ...
    def test_npu_grouped_matmul_add_(self):
        ...
        my = y.clone()
        mgroup_list = group_list.clone()
        torch_npu.npu_grouped_matmul_add_(y, x, weight, group_list, transpose_x=transpose_x, transpose_weight=transpose_weight, group_type=group_type, group_list_type=group_list_type)
    ...
    def test_npu_grouped_matmul_add(self):
        ...
        my = y.clone()
        mgroup_list = group_list.clone()
        res = torch_npu.npu_grouped_matmul_add(
    ...
    def test_npu_grouped_matmul_add(self):
        ...
        my = y.clone()
        mgroup_list = group_list.clone()
        res = torch_npu.npu_grouped_matmul_add(y, x, weight, group_list, transpose_x=transpose_x,
                                               transpose_weight=transpose_weight, group_type=group_type, group_list_type=group_list_type)
