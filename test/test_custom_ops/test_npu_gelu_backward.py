...
class TestNPUGeluBackward(TestCase):
    ...
    def test_npu_gelu_backward_float16_tanh(self):
        shape = [100, 400]
        mode = "tanh"
    ...
    def test_npu_gelu_backward_float16_none(self):
        shape = [100, 400]
        mode = "none"
    ...
    def test_npu_gelu_backward_float32_tanh(self):
        shape = [500, 400, 100]
        mode = "tanh"
    ...
    def test_npu_gelu_backward_float32_none(self):
        shape = [500, 400, 100]
        mode = "none"
