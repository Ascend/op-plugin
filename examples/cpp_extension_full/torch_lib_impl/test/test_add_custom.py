...
class TestCustomAdd(TestCase):
    def test_add_custom(self):
        ...
        # calculate on npu
        output = torch.ops.cpp_extension_full.add_custom(x_npu, y_npu)
    ...
    def test_add_custom_meta(self):
        ...
        custom_out = torch.ops.cpp_extension_full.add_custom(x_input1, y_input1)
    ...
    def test_add_custom_ops(self):
        ...
        # calculate on npu
        output = cpp_extension_full.ops.add_custom(x_npu, y_npu)
        output.backward(output)
